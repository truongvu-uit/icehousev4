...
keystone endpoint-create --service-id $(keystone service-list | awk '/ network / {print $2}') --publicurl http://$CON_EXT_IP:9696 --adminurl http://controller:9696 --internalurl http://controller:9696
...
###core_plugin = ml2.plugin.Ml2Plugin
...
[service_providers]
#service_provider=LOADBALANCER:Haproxy:neutron.services.loadbalancer.drivers.haproxy.plugin_driver.Hap#roxyOnHostPluginDriver:default
